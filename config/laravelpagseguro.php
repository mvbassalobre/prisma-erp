...
return [
    ...
    'use-sandbox' => env('PAGSEGURO_CREDENTIALS_SANDBOX', true),
    ...
    'routes' => [
        'redirect' => [
            'route-name' => 'admin.pagseguro.teste', // Criar uma rota com este nome
        ],
        'notification' => [
            ...
            'route-name' => 'admin.pagseguro.notification', // Criar uma rota com este nome
        ],
    ],
