        ...
        <div class="card h-100">
            <div class="card-body d-flex flex-column">
                <span class="f-12 mb-3">
                    ...
                    </b> / Novas análises no periodo do filtro
                </span>
                        ...
                        <table class="table table-striped table-sm f-12 my-0">
                            <tbody>
                                ...
                                <div v-else class="text-center">
                                    <span class="f-12">Não há novas análises ...</span>
                                </div>
                            </tbody>
                        </table>
                    </template>
...
export default {
    ...
    methods: {
        init() {
            this.attempts++
            this.$http.post(`${laravel.general.root_url}/admin/dashboard/get_info/TopUsersWithPayment`, { ...this.filter }).then(resp => {
                setTimeout(() => {
                    resp = resp.data
                    this.data = resp
                    this.loading = false
