    ...
    <div class="card mb-2">
        <div class="card-header cursor-pointer" @click="opened = !opened">
            <div class="w-100 d-flex flex-row justify-content-between align-items-center">
                <span class="el-icon-menu mr-2"></span>Detalhes da Listagem Reuniões
                <span
...
export default {
    ...
    methods: {
        ...
        getTotal() {
            this.attempts.total++
            this.$http.post(`/admin/meetings/metrics/total`, { ...this.get_params }).then(resp => {
        ...
        getTeams() {
            this.attempts.teams++
            this.$http.post(`/admin/meetings/metrics/teams`, { ...this.get_params }).then(resp => {
        ...
        getUsers() {
            this.attempts.users++
            this.$http.post(`/admin/meetings/metrics/users`, { ...this.get_params }).then(resp => {
