                                        ...
                                        <tbody>
                                            <tr v-for="(row,i) in result.data" :key="i">
                                                <td>
                                                    <a
                                                        class="link"
                                                        :href="`/admin/meetings/${row.code}`"
                                                        target="_BLANK"
                                                        v-html="row.code"
                                                    />
                                                </td>
                                                <td>
                                                    <div v-html="row.room" v-if="!row.room" />
                                                    <a
                                                        v-else
                                                        target="_BLANK"
                                                        class="link"
                                                        :href="`/admin/meeting-rooms/${row.room_code}`"
                                                        v-html="row.room"
                                                    />
                                                </td>
                                                <td>
                                                ...
                                                <td v-html="`${row.start_at} - ${row.end_at}`" />
...
export default {
    ...
    methods: {
        refresh(filter) {
            ...
            this.$http.post("/admin/reports/get-data-meetings/table", { page: this.page, ...filter }).then(resp => {
                resp = resp.data
