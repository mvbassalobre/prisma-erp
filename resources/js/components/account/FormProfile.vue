                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 d-flex align-items-center justify-content-center flex-column">
                                    <animated-thumb height='140px' width='140px'>
                                        <template slot="cover">
                                            <div
                                                class="avatar-uploader d-flex align-items-center justify-content-center color">
                                                <div class="avatar">
                                        ...
                                        <template slot="back">
                                            <el-upload class="d-flex align-items-center justify-content-center mt-4"
                                                :action="uploadRoute" :headers="header" :show-file-list="false"
                                    ...
                                    <a href="#" class='text-danger mt-3' @click.prevent="destroyAvatar"
                                        v-if="user.avatar">Excluir Avatar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <button class="btn btn-primary" @click="openEditModal"><span
                                            class="el-icon-edit mr-2"></span>Editar</button>
                                </div>
                            </div>
                        </div>
                        <el-dialog :close-on-click-modal="false" :close-on-press-escape="false"
                            :visible.sync="user_dialog_visible" :before-close="handleCloseDialog" v-loading="loading">
                            <form class="needs-validation mt-4" novalidate v-on:submit.prevent="submit">
                                <div class="col-12 form-label-group">
                                    <v-input class="mb-3" :label="`<b>Nome</b>`"
                                        :prepend="`<i class='el-icon-user text-secondary'></i>`"
                                        v-model="editing_form.name" placeholder="Digite aqui seu nome ..."
