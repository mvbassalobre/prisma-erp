    ...
    <div class="d-flex flex-row align-items-end">
      <div>
        ...
        <small>
          Olá
          <b>{{ user.name }}</b
          >, aqui no dashboard você verá um informativo resumido a respeito de
          sua empresa
        </small>
      </div>
      <div class="ml-auto">
...
export default {
  ...
  components: {
    ...
    'top-users-new-customers': require('./partials/-TopUsersNewsCustomer.vue')
      .default,
    'top-teams-new-customers': require('./partials/-TopTeamsNewsCustomer.vue')
      .default,
    'top-teams-new-meeting': require('./partials/-TopTeamsNewMeeting.vue')
      .default,
    'top-users-new-meeting': require('./partials/-TopUsersNewMeeting.vue')
      .default,
  ...
  created() {
    if (this.params.daterange)
      this.filter.daterange = this.params.daterange.split(',')
  },
  watch: {
    filter: {
      handler(val) {
