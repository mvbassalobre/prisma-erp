...
export default {
    ...
    methods: {
        initialize() {
            this.attempts++
            this.$http.post(`${laravel.general.root_url}/admin/dashboard/get_info/qtyProducts`, {}).then(res => {
                setTimeout(() => {
                    res = res.data
