        ...
        <div class="card h-100">
            <div class="card-body d-flex flex-column">
                <span class="f-12 mb-3">
                    <b>
                        <span class="el-icon-trophy mr-2"></span>TOP 5 TIMES
                                        ...
                                        <tr :key="i">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <small
                                                        class="f-12"
                                                    >{{p}} {{(p>1) ? "Reuniões Agendadas" : "Reunião Agendada"}}</small>
                                                </div>
                                            </td>
                                        </tr>
                                    </template>
...
export default {
    ...
    methods: {
        init() {
            this.attempts++
            this.$http.post(`${laravel.general.root_url}/admin/dashboard/get_info/topTeamNewMeeting`, { ...this.filter }).then(resp => {
                setTimeout(() => {
                    resp = resp.data
                    this.data = resp
                    this.loading = false
