<template>
  <div class="alert alert-info alert-dismissible fade show" role="alert" v-show="visible">
    <b class="mr-2">
    ...
    aniversário.
    <a class="ml-4" href="/admin/birthdays" v-if="hide_link == undefined">Clique aqui para ver mais detalhes</a>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close" v-if="hide_link == undefined">
